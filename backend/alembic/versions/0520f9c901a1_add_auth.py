...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('EMPLOYEE', 'ADMIN', 'ORGANIZATION', name='user_role'), nullable=False),
    ...
    op.create_index(op.f('ix_refresh_sessions_refresh_jti'), 'refresh_sessions', ['refresh_jti'], unique=False)
